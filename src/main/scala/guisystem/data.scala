...
object DataUtils
{
	def EncodeHex(what:String) = org.apache.commons.codec.binary.Hex.encodeHexString(what.getBytes)
	def DecodeHex(what:String) = new String(org.apache.commons.codec.binary.Hex.decodeHex(what.toCharArray))
